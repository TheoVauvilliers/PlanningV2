...
// Returns the private 'App\Repository\TypevenRepository' shared autowired service.
...
include_once $this->targetDirs[3].'\\src\\Repository\\TypevenRepository.php';

return $this->privates['App\Repository\TypevenRepository'] = new \App\Repository\TypevenRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
