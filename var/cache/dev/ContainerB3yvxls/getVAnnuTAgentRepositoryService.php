...
// Returns the private 'App\Repository\VAnnuTAgentRepository' shared autowired service.
...
include_once $this->targetDirs[3].'\\src\\Repository\\VAnnuTAgentRepository.php';

return $this->privates['App\Repository\VAnnuTAgentRepository'] = new \App\Repository\VAnnuTAgentRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
