...
// Returns the private 'App\Repository\LieuRepository' shared autowired service.
...
include_once $this->targetDirs[3].'\\src\\Repository\\LieuRepository.php';

return $this->privates['App\Repository\LieuRepository'] = new \App\Repository\LieuRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
