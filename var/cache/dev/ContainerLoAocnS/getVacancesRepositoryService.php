...
// Returns the private 'App\Repository\VacancesRepository' shared autowired service.
...
include_once $this->targetDirs[3].'\\src\\Repository\\VacancesRepository.php';

return $this->privates['App\Repository\VacancesRepository'] = new \App\Repository\VacancesRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
