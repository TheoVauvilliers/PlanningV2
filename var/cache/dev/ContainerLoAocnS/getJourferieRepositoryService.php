...
// Returns the private 'App\Repository\JourferieRepository' shared autowired service.
...
include_once $this->targetDirs[3].'\\src\\Repository\\JourferieRepository.php';

return $this->privates['App\Repository\JourferieRepository'] = new \App\Repository\JourferieRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
