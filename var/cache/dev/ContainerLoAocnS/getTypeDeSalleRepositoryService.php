...
// Returns the private 'App\Repository\TypeDeSalleRepository' shared autowired service.
...
include_once $this->targetDirs[3].'\\src\\Repository\\TypeDeSalleRepository.php';

return $this->privates['App\Repository\TypeDeSalleRepository'] = new \App\Repository\TypeDeSalleRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
